...
class xy_rect : public hittable
{
    ...
    public:
        ...
        {
            // The bounding box mush have non-zero width in each dimension
            // so pad the Z dimension in a samll amount.
...
class xz_rect : public hittable 
{
    ...
    public:
        ...
        virtual bool bounding_box(double time0, double time1, aabb &output_box) const override
        {
            // Pad the Y dimension a small amount
...
class yz_rect : public hittable 
{
    ...
    public:
        ...
        virtual bool bounding_box(double time0, double time1, aabb &output_box) const override
        {
            // Pad the X dimension a small amount
